...
# MAIN
def radar():#if __name__ == "__main__":
    ...
    plt.show()
#t1=threading.Thread(target=radar, args=())
#t1.start()
dsf=2.7e9
#tabor1=0
#tabor2=0
...
while True:
    ...
    radial=rect2polar([triangulate(pred)[0]*-1,triangulate(pred)[1]])
    r = radial[0]
    theta = radial[1]
    #radarUpdate(anim)
